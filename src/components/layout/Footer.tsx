...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://bookyourhotel.online";
const shareText = "Search over 2 million hotels worldwide. Simple booking, perfect stays.";
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              },
              {
                ...
                onClick: () =>
                  window.open(
                    `https://twitter.com/intent/tweet?url=${encodeURIComponent(siteUrl)}&text=${encodeURIComponent(shareText)}`,
                    "_blank",
                    "noopener,noreferrer,width=600,height=500",
                  ),
                icon: (
              ...
              },
              {
                ...
                onClick: () =>
                  window.open(
                    `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(siteUrl)}&title=${encodeURIComponent("BookYourHotel - Simple Booking, Perfect Stays.")}`,
                    "_blank",
                    "noopener,noreferrer,width=600,height=500",
                  ),
                icon: (
              ...
              },
              {
                ...
                onClick: async () => {
                  if (navigator.share) {
                    try {
                      await navigator.share({ title: "BookYourHotel", text: shareText, url: siteUrl });
              ...
              <button
                ...
                title={social.label}
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-accent-bright hover:border-accent-bright/30 transition-colors duration-200 cursor-pointer"
              >
                {social.icon}
              </button>
            ))}

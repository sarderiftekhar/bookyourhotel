    ...
    >
      {socials.map((s) => (
        <a
          ...
          aria-label={s.label}
          className="w-9 h-9 rounded-full bg-white border border-border shadow-sm flex items-center justify-center text-text-muted hover:bg-accent hover:text-white hover:border-accent hover:shadow-md hover:scale-110 transition-all duration-200"
        >
          {s.icon}
        </a>
      ))}
